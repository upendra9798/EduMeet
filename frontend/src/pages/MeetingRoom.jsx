...
const MeetingRoom = ({ user }) => {
  ...
  const setupSocketListeners = () => {
    ...
    MeetingSocket.on('message-received', (message) => {
      ...
      console.log('MeetingRoom: Adding received message to state:', receivedMessage);
      setMessages(prev => {
        const updated = [...prev, receivedMessage];
        console.log('MeetingRoom: Updated messages with received message:', updated);
        return updated;
      });
    });
  };
  ...
  const toggleMute = () => {
    console.log('toggleMute called - isMuted:', isMuted, 'localStream:', localStream);
    if (localStream) {
  ...
  const toggleVideo = () => {
    console.log('toggleVideo called - isVideoOff:', isVideoOff, 'localStream:', localStream);
    if (localStream) {
  ...
  const sendMessage = () => {
    ...
    if (newMessage.trim() && joined) {
      ...
      console.log('MeetingRoom: Socket connection state:', MeetingSocket.isConnected);
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center">
        <div className="text-center">
          <div className="relative mb-8">
            ...
            <div className="absolute inset-0 w-20 h-20 border-4 border-purple-500/30 rounded-full animate-spin border-t-purple-400" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-900 via-gray-900 to-red-800 flex items-center justify-center p-4">
        <div className="bg-white/95 backdrop-blur-lg p-10 rounded-3xl shadow-2xl max-w-md w-full border border-red-200">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Unable to Join Meeting</h2>
        ...
        <main className="flex-1 relative">
          {activeView === 'video' && (
            <div className="h-full">
              <VideoChat meetingId={meetingId} userId={user.id} localStream={localStream} />
            </div>
          )}
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-lg font-semibold text-blue-300">Participants</h4>
      ...
      <footer className="bg-black/60 backdrop-blur-lg p-6 flex items-center justify-center border-t border-white/10">
        <div className="flex items-center space-x-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <span className="text-xs text-gray-300 mt-2 font-medium">Leave</span>
          </div>
          ...
          {isHost && (
            <div className="flex flex-col items-center ml-6 pl-6 border-l border-white/20">
              ...
              <span className="text-xs text-gray-300 mt-2 font-medium">Host Controls</span>
            </div>
          )}
          ...
          <div className="flex flex-col items-center ml-6 pl-6 border-l border-white/20">
            ...
            <span className="text-xs text-gray-300 mt-2 font-medium">Settings</span>
          </div>
        </div>
      </footer>
    </div>
